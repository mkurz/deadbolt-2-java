...
public class SubjectPresentTest extends AbstractFakeApplicationTest
{
    ...
    public void testWithSubjectPresent()
    {
        ...
        final Content html = be.objectify.deadbolt.java.views.html.subject.subjectPresentContent.render(deadboltHandler);
    ...
    {
        final Content html = be.objectify.deadbolt.java.views.html.subject.subjectPresentContent.render(new AbstractNoPreAuthDeadboltHandler(){});
        final String content = Helpers.contentAsString(html);
        Assert.assertTrue(content.contains("This is before the constraint."));
