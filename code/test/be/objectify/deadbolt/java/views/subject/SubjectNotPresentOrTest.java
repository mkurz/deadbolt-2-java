...
public class SubjectNotPresentOrTest extends AbstractFakeApplicationTest
{
    ...
    {
        final Content html = new be.objectify.deadbolt.java.views.html.subject.subjectNotPresentOrContent(new be.objectify.deadbolt.java.views.html.subjectNotPresentOr(app.asScala())).render(handlers.apply("present"));
    ...
    {
        final Content html = new be.objectify.deadbolt.java.views.html.subject.subjectNotPresentOrContent(new be.objectify.deadbolt.java.views.html.subjectNotPresentOr(app.asScala())).render(handlers.apply("notPresent"));
        final String content = Helpers.contentAsString(html);
        Assert.assertTrue(content.contains("This is before the constraint."));
