...
public class SubjectNotPresentTest extends AbstractFakeApplicationTest
{
    ...
    public void testWithSubjectPresent()
    {
        ...
        final Content html = be.objectify.deadbolt.java.views.html.subject.subjectNotPresentContent.render(deadboltHandler);
    ...
    {
        final Content html = be.objectify.deadbolt.java.views.html.subject.subjectNotPresentContent.render(new AbstractNoPreAuthDeadboltHandler(){});
        final String content = Helpers.contentAsString(html);
        Assert.assertTrue(content.contains("This is before the constraint."));
