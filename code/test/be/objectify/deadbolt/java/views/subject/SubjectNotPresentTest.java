...
public class SubjectNotPresentTest extends AbstractFakeApplicationTest
{
    ...
    {
        final Content html = be.objectify.deadbolt.java.views.html.subject.subjectNotPresentContent.render(handlers.apply("present"));
    ...
    {
        final Content html = be.objectify.deadbolt.java.views.html.subject.subjectNotPresentContent.render(handlers.apply("notPresent"));
        final String content = Helpers.contentAsString(html);
        Assert.assertTrue(content.contains("This is before the constraint."));
