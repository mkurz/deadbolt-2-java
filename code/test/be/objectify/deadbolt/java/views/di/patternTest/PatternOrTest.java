...
import be.objectify.deadbolt.java.views.html.di.patternOr;
import be.objectify.deadbolt.java.views.html.di.patternTest.patternOrContent;
...
public class PatternOrTest extends AbstractFakeApplicationTest
{
    ...
    private patternOrContent patternOrContent(final DeadboltHandler deadboltHandler) {
        return new patternOrContent(new patternOr(viewSupport(),
                                                  handlers(deadboltHandler)));
    }

    @Override
    protected HandlerCache handlers(final DeadboltHandler handler) {
        return new TestHandlerCache(handler,
                                    new HashMap<>());
    }
