...
import be.objectify.deadbolt.java.views.html.di.dynamicOr;
import be.objectify.deadbolt.java.views.html.di.dynamicTest.dynamicOrContent;
...
public class DynamicOrTest extends AbstractFakeApplicationTest
{
    ...
    private dynamicOrContent dynamicOrContent() {
        return new dynamicOrContent(new dynamicOr(viewSupport(),
                                                  handlers()));
    }
