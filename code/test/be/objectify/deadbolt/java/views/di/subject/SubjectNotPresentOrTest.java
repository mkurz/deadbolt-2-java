 ...
 */
package be.objectify.deadbolt.java.views.di.subject;
...
import be.objectify.deadbolt.java.views.html.di.subject.subjectNotPresentOrContent;
import be.objectify.deadbolt.java.views.html.di.subjectNotPresentOr;
...
public class SubjectNotPresentOrTest extends AbstractFakeApplicationTest
{
    ...
    private subjectNotPresentOrContent subjectNotPresentOrContent() {
        return new subjectNotPresentOrContent(new subjectNotPresentOr(viewSupport(),
                                                                      handlers()));
    }
