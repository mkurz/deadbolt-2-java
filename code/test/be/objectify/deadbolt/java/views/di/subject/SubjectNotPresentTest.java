...
import be.objectify.deadbolt.java.views.html.di.subject.subjectNotPresentContent;
...
public class SubjectNotPresentTest extends AbstractFakeApplicationTest
{
    ...
    private subjectNotPresentContent subjectNotPresentContent() {
        return new subjectNotPresentContent(new subjectNotPresent(viewSupport(),
                                                                  handlers()));
    }
