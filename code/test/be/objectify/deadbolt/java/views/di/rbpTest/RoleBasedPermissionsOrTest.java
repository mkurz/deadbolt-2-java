...
import be.objectify.deadbolt.java.views.html.di.rbpTest.roleBasedPermissionsOrContent;
import be.objectify.deadbolt.java.views.html.di.roleBasedPermissionsOr;
 ...
 */
public class RoleBasedPermissionsOrTest extends AbstractFakeApplicationTest
{
    @Test
    ...
    private roleBasedPermissionsOrContent roleBasedPermissionsOrContent() {
        return new roleBasedPermissionsOrContent(new roleBasedPermissionsOr(viewSupport(),
                                                                            handlers()));
    }
