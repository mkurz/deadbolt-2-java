...
import be.objectify.deadbolt.java.views.html.di.subject.subjectPresentOrContent;
...
public class SubjectPresentOrTest extends AbstractFakeApplicationTest
{
    ...
    private subjectPresentOrContent subjectPresentOrContent() {
        return new subjectPresentOrContent(new subjectPresentOr(viewSupport(),
                                                                handlers()));
    }
