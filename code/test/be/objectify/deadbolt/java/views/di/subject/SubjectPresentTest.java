...
import be.objectify.deadbolt.java.views.html.di.subject.subjectPresentContent;
...
public class SubjectPresentTest extends AbstractFakeApplicationTest
{
    ...
    private subjectPresentContent subjectPresentContent() {
        return new subjectPresentContent(new subjectPresent(viewSupport(),
                                                            handlers()));
    }
